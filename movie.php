...
<div id="main-container" class="container-fluid">
    <div class="row">
        <div class="offset-md1 col-md-6 movie-container">
            ...
            <iframe src="<?= $movie->trailer ?>" width="560" height="315" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encryted-media; gyroscope; picture=in-pincture" allowfullscreen></iframe>
        ...
        <div class="offset-md1 col-md-10" id="reviews-container">
